...
var BattleSettlementArena = function(manager) {
...
inherits(BattleSettlementArena, BattleSettlement);

BattleSettlementArena.prototype.expSettlement = function (level, stamina) {
    return this.expCalculate.calculate(this.EXP_CONT_BASE, this.EXP_CONT_RATIO, level, stamina);
}

BattleSettlementArena.prototype.coinSettlement = function (level, stamina) {
    return this.coinCalculate.calculate(this.COIN_CONT_BASE, this.COIN_CONT_RATIO, level, stamina);
}

module.exports = BattleSettlementArena;