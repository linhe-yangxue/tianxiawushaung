...
/**
 * [当前为生成代码，不可以修改] MallShopConfig 类为 MallShopConfigTable 每一行的元素对象
 * */
var MallShopConfig = (function() {

    /**
    * 构造函数
    */
    function MallShopConfig() {
        this.INDEX = 0;
        this.TAB_ID = 0;
        this.TAB_NAME = '';
        this.ITEM_ID = 0;
    ...
    return MallShopConfig;
})();

/**
 * [当前为生成代码，不可以修改] MallShopConfig 配置表
 * */
var MallShopConfigTableInstance = (function() {
    ...
    */
    function Instance() {
        if(_unique === undefined) {
            _unique = new MallShopConfigTable();
        }
        return _unique;
    }
    ...
    * 构造函数
    */
    function MallShopConfigTable() {
        _lines = {};
        var tmpArr = csvParse.Instance().getTable('MallShopConfig');
        for(var i = 0; i < tmpArr.length; ++i) {
            var obj = new MallShopConfig();
    ...
    * 获取行队列
    */
    MallShopConfigTable.prototype.GetLines = function() {
        return _lines;
    };
...
* 声明一个单例对象
*/
exports.Instance = MallShopConfigTableInstance;
